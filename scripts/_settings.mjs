...
export const FEATURES = [
  ...
  { key: "WA_STATUS", label: "She posts WhatsApp Status (story)", kind: "bool", def: 1, hint: "3-4 posts a day that tell the story of her day" },
  { key: "STATUS_PER_DAY", label: "Status posts per day", kind: "int", def: 3 },
  { key: "STATUS_AUDIENCE", label: "Who sees her status (all / trusted)", kind: "text", def: "all" },
  { key: "STATUS_QUIET_START", label: "Status: no posting from this hour", kind: "int", def: 2 },
  ...
  { key: "SELFIE_ENABLED", label: "Kirim selfie terjadwal", kind: "bool", def: 1 },
  { key: "SELFIE_SCHEDULE", label: "Selfie: jam cadangan", kind: "text", def: "07:30,16:30" },
  { key: "SELFIE_SPOT", label: "Selfie: tempatnya (jangan diubah)", kind: "text", def: "the full-length mirror on the inside of her bedroom door" },
  { key: "SELFIE_MAX_PER_DAY", label: "Selfie: maksimal per hari", kind: "int", def: 2 },
  ...
  { key: "SELFIE_TIME", label: "Selfie: waktu (auto/subuh/pagi/siang/sore/magrib/malem/tengahmalam)", kind: "text", def: "auto" },
  ...
  { key: "ODD_HOUR_NOTE", label: "She reacts to being messaged at 4am", kind: "bool", def: 1 },
  { key: "EDIT_CHANCE", label: "Chance she edits a message to add an afterthought", kind: "float", def: 0.05 },
  { key: "SKIP_TERMINAL_CHANCE", label: "Left on read: message was just an acknowledgement", kind: "float", def: 0.6 },
  { key: "SKIP_BORED_CHANCE", label: "Left on read: nothing in it for her", kind: "float", def: 0.15 },
  { key: "SKIP_FLOOD_PER_MIN", label: "Left on read: messages per minute that count as spam", kind: "int", def: 5 },
  { key: "SKIP_LOW_ENERGY_CHANCE", label: "Left on read: she is out of energy", kind: "float", def: 0.35 },
  { key: "SKIP_COLD_CHANCE", label: "Left on read: short fuse", kind: "float", def: 0.3 },
  { key: "SKIP_CARRYING_CHANCE", label: "Left on read: she has been carrying the chat", kind: "float", def: 0.25 },
  { key: "DAILY_VARIANCE", label: "Moods vary from day to day", kind: "bool", def: 1, hint: "some days she wakes up flat for no reason, applied once per day" },
  { key: "DAILY_SPREAD", label: "How big that daily swing is (0-0.3)", kind: "float", def: 0.08 },
  { key: "BUSY_BLOCKS", label: "Her routine blocks replies", kind: "bool", def: 1, hint: "during work, a class or the gym she does not drop everything to answer" },
  { key: "BUSY_REPLY_CHANCE", label: "Chance she says she is busy instead of going quiet", kind: "float", def: 0.45 },
  { key: "BUSY_DELAY_MAX_MIN", label: "Longest she waits before answering anyway (minutes)", kind: "int", def: 20 },
  { key: "CHANGE_FEED", label: "Push character changes to every chat", kind: "bool", def: 1, hint: "an edit to her card or traits reaches every conversation immediately, with the diff" },
  { key: "CHANGE_WATCH_FILES", label: "Notice edits made to the files directly", kind: "bool", def: 1, hint: "watch persona/traits/world files on disk, not only the dashboard" },
  { key: "CHANGE_NOTIFY", label: "Notify me when the agent edits her", kind: "bool", def: 1, hint: "a phone notification with the diff when the change came from the agent" },
